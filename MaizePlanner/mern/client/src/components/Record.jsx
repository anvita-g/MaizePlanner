...
export default function Record() {
  ...
  return (
    <>
      ...
      >
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-blue-900/10 pb-12 md:grid-cols-2">
          <div>
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-blue-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <input
                    ...
                    name="name"
                    id="name"
                    className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-blue-900 placeholder:text-slate-400 focus:ring-0 sm:text-sm sm:leading-6"
                ...
                <div className="space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      type="radio"
                      value="Senior"
                      className="h-4 w-4 border-slate-300 text-slate-600 focus:ring-blue-600 cursor-pointer"
                      checked={form.level === "Senior"}
                      onChange={(e) => updateForm({ level: e.target.value })}
                    />
                    <label
                      htmlFor="positionSenior"
                      className="ml-3 block text-sm font-medium leading-6 text-blue-900 mr-4"
                    >
                      Senior
                    </label>
                  </div>
